...
- 公开上线前在 [Riot Developer Portal](https://developer.riotgames.com/) 登记产品；即使当前版本未调用标准 Riot API，也不要跳过面向玩家的第三方产品登记
- 保留 Riot 要求的非背书声明，并在提交登记信息时准确描述 GCD、Leaguepedia 和 Redis 的实际用途
